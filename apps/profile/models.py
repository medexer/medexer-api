...
class Profile(TimeStampedUUIDModel):
    ...
    hospitalImagePublicId = models.CharField(max_length=255, default="00000", blank=True, null=True)
    ...
    hospitalLogoPublicId = models.CharField(max_length=255, default="00000", blank=True, null=True)
