...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    # city = models.CharField(max_length=255, unique=True, blank=True, null=True)
    lga = models.CharField(max_length=255, unique=True, blank=True, null=True)
    state = models.CharField(max_length=255, unique=True, blank=True, null=True)
    postalCode = models.CharField(max_length=255, unique=True, blank=True, null=True)
