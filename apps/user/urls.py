...
urlpatterns = [
    ...
    path("auth/hospital/forgot-password", views.hospital_forgotpassword_viewset, name="hospital-forgot-password"),
    path("auth/hospital/reset-password", views.hospital_resetpassword_viewset, name="hospital-reset-password"),
