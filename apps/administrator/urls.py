...
urlpatterns = [
    ...
    path('customers/hospital/approve-account/<int:hospital>', views.hospital_approve_account_viewset, name="approve-hospital-account"),
    path('customers/hospital/block-unblock-account/<int:hospital>', views.hospital_approve_account_viewset, name="block-unblock-hospital-account"),
    path('customers/donor/block-unblock-account/<int:donor>', views.donor_block_unblock_account_viewset, name="block-unblock-donor-account"),
